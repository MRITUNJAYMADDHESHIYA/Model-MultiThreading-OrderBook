////////////////////For Runing
// cd "c:\Users\Mritunjay Maddhesiya\OneDrive\Desktop\C++HFT\BuildingChatRoom"
// g++ chatRoom.cpp -std=c++17 -I"C:/boost_1_88_0" -lws2_32 -o chatRoom.exe
// chatRoom.exe
...
void Room::deliver(ParticipantPointer participant, Message &message){
    ...
    while(!messageQueue.empty()){
        ...
        for(ParticipantPointer _it:participant){
            if(participant != _it){
                _it->write(msg);
            }
        }
