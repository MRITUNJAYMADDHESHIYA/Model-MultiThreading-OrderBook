...
// 
// 
//Batana hai + Bhejna hai + Brij hai
//                              |
//NotificationService(sendNotification(Notification n), vector<Notification> store)==(obserable referance + notification reference)
//
//   <<abstract>>                                                                 <<abstract>>
// INotification(getcontant())<---------------------------------------------------Observable(vector<Observer>, add, remove, notify)<----------NotificationObserablve(INotification, add, remove, notify, getNotication, setNotification)
//   |            |     |<-------------------------------------------------------------------------------------------------------------------------|
//   | is a       | has a
//   |            |
//   |            |<<abstract>>
...
// 
//
//IObserver(update())------>logger(update())
//     |------------------->NotifiEngine(vector<INotificationS>, update)
//                              |
//  <<abstract>>                |
// INotificationStrategy(sendNotify)----->EmailStrategy(sendNotify()) + SMSStrategy + popUPStrategy
// 
// 
// 
// 
